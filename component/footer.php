            ...
            <div class="col-lg-6 col-md-6">
                ...
                <div class="d-flex">
                    ...
                    <a class="btn btn-lg btn-primary btn-lg-square rounded"
                        href="https://www.instagram.com/bhayani_dental_clinic"><i class="bi bi-instagram"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row g-0">
            <div class="col-md-6 text-center text-md-start">
                <p class="mb-md-0 text-white">&copy; <a class="text-white border-bottom"
                        href="#">bhayanidentalclinic.com</a>.
                    All
                    Rights Reserved.</p>
            </div>

                ...
                <div class="col-lg-7">
                    ...
                    <div class="row g-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.3s">
                            <h5 class="mb-3 text-primary"><i class="fa fa-check-circle text-primary me-3"></i>Award
                                Winning</h5>
                            <h5 class="mb-3 text-primary"><i
                                    class="fa fa-check-circle text-primary me-3"></i>Professional Staff</h5>
                        </div>
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.6s">
                            <h5 class="mb-3 text-primary"><i class="fa fa-check-circle text-primary me-3"></i>24/7
                                Opened</h5>
                            <h5 class="mb-3 text-primary"><i class="fa fa-check-circle text-primary me-3"></i>Fair
                                Prices</h5>
                        </div>
                    </div>

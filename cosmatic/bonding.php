    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">Bonding</h1>
            ...
            <div class="row g-5 mb-5">
                ...
                <div class="col-lg-10">
                    <div class="section-title mb-5">
                        ...
                        <h4 class="display-5 mb-0">Eliminate little imperfections</h4>
                        <p class="mb-4">Small chips, gaps, and stains put a damper on your confidence and
                            oral health, and can drive you crazy. Dental bonding is a simple yet effective solution.
                            Bonding involves applying a natural white composite resin directly to your teeth to cover
                            your damaged tooth, hide imperfections, and provide a beautiful and durable smile.
                        </p>
                        <p class="mb-4">
                            Best of all, the entire treatment can be completed in just one easy visit.</p>
                        <h3 class="mt-5 mb-0">Bonding can address a variety of minor concerns:</h3>
                        <ul>
                            <li>
                                <h4 class="text-body">A single discolored tooth</h4>
                            </li>
                            <li>
                                <h4 class="text-body">Small gaps between teeth</h4>
                            </li>
                            <li>
                                <h4 class="text-body">Little chips, cracks, or cavities</h4>
                            </li>
                            <li>
                                <h4 class="text-body">Improperly shaped tooth</h4>
                            </li>
                        </ul>
                    </div>
                    <!-- <div class="row g-5">
                ...
                <div class="col-lg-12">
                    <div class="row g-5">
                        <div class="col-md-7 service-item wow zoomIn" data-wow-delay="0.3s">
                            ...
                            <ul>
                                <li>
                                    <h4 class="text-body">Do you wish there was something you could do to improve your
                                        smile?</h4>
                                </li>
                                <li>
                                    <h4 class="text-body">Dental bonding treatments may be the perfect solution for you.
                                        Bonding is a high-tech and minimally invasive option for fixing small issues
                                        with your smile.</h4>
                                </li>
                                <li>
                    ...
                    <div class="row g-5">
                        <div class="col-md-6 service-item wow zoomIn" data-wow-delay="0.3s">
                            <div class="rounded-top overflow-hidden image-container-all height-500">
                                <img class="img-fluid" src="../img/cosmetic/bonding-1.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-md-6 service-item wow zoomIn" data-wow-delay="0.6s">
                            <div class="rounded-top overflow-hidden image-container-all height-500">
                                <img class="img-fluid" src="../img/cosmetic/bonding-2.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>

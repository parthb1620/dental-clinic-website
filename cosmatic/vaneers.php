    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">Veneers (Smile Design)</h1>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-10">
                    <div class="section-title mb-5">
                        ...
                        <h4 class="display-5 mb-0 ">Gorgeous, natural-looking veneers</h4>
                        <p class=" mb-4">Improve the appearance of your teeth and smile with veneers. Usually
                            made of porcelain or resin, veneers are thin, custom-made shells that fit around your teeth.
                            This treatment completely transforms the shape, color, length, or size of your teeth.
                        </p>
                        <p class="">
                            Our dentists take a comprehensive approach to veneers. We’ll address any underlying dental
                            health treatments before addressing cosmetic imperfections. When planning your treatment,
                            we’ll ensure your veneers not only improve your smile but complement the natural shape of
                            your face.</p>
                ...
                <div class="col-lg-12">
                    <div class="row g-5">
                        <div class="col-md-6 service-item wow zoomIn" data-wow-delay="0.3s">
                            <h4 class="mb-2 ">Total makeover for your smile</h4>
                            <h4 class="text-body">Corrects gaps, chips, stains, and worn teeth.</h4>
                        </div>
                        <div class="col-md-6 service-item wow zoomIn" data-wow-delay="0.3s">
                            <h4 class="mb-2 ">Fix a single issue</h4>
                            <h4 class="text-body">Also effective for improving just one tooth.
                            </h4>
                        </div>
                    </div>
                    <div class="row g-5">
                        <div class="col-md-6 service-item wow zoomIn" data-wow-delay="0.3s">
                            ...
                            <h4 class="text-body">Natural-looking and customized for a flawless smile.</h4>
                        </div>
                        <div class="col-md-6 service-item wow zoomIn" data-wow-delay="0.3s">
                            <h4 class="mb-2 ">Quick results</h4>
                            <h4 class="text-body">Coined the “instant orthodontic treatment”.</h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="row g-5">
                        <div class="col-md-7 service-item wow zoomIn" data-wow-delay="0.3s">
                            ...
                            <h6 class="text-body mb-6">Are you unhappy with certain aspects of your smile? Dentistry
                                should improve both your health and quality of life.</h6>

                            <h6 class="text-body mb-6">At Bhayani Dental Clinic, we want our patients to be able to
                                enjoy the benefits of great oral health and a beautiful smile. Veneers may be
                                the perfect solution for you. Dental veneers have the power to provide small
                                smile touch-ups and dramatic transformations that help turn your dream smile
                                into a reality.</h6>

                            <h6 class="text-body mb-6">Your dentist is committed to giving you a healthy and happy
                                smile so you can live your best life.</h6>

                            <h6 class="text-body">This is everything dental care should be.</h6>
                    ...
                    <div class="row g-5">
                        <div class="col-md-4 service-item wow zoomIn" data-wow-delay="0.3s">
                            <div class="rounded-top overflow-hidden image-container-denture">
                                <img class="img-fluid" src="../img/cosmetic/smile-design-1.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-md-4 service-item wow zoomIn" data-wow-delay="0.6s">
                            <div class="rounded-top overflow-hidden image-container-denture">
                                <img class="img-fluid" src="../img/cosmetic/smile-design-2.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-md-4 service-item wow zoomIn" data-wow-delay="0.s">
                            <div class="rounded-top overflow-hidden image-container-denture">
                                <img class="img-fluid" src="../img/cosmetic/smile-design-3.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>

    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">Extractions</h1>
            ...
            <div class="row g-5 mb-5">
                <div class="col-lg-6 wow zoomIn" data-wow-delay="0.3s" style="min-height: 300px;">
                    ...
                    <div class="h-200 rounded overflow-hidden wow zoomIn" data-wow-delay="0.6s">
                        <img class="img-fluid" src="../img/surgical/extractions-main.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                            ...
                            <ul>
                                <li>
                                    <h4 class="text-body">At Bhayani Dental Clinic, we specialize in safe and painless
                                        dental extractions using advanced techniques and equipment. Our experienced team
                                        ensures a comfortable experience while prioritizing your oral health. Trust us
                                        for expert care and personalized guidance every step of the way.</h4>
                                </li>
                                <li>
                    ...
                    <div class="row g-5">
                        <div class="col-md-6 service-item wow zoomIn" data-wow-delay="0.3s">
                            <div class="rounded-top overflow-hidden image-container-denture">
                                <img class="img-fluid" src="../img/surgical/extractions-1.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-md-6 service-item wow zoomIn" data-wow-delay="0.6s">
                            <div class="rounded-top overflow-hidden image-container-denture">
                                <img class="img-fluid" src="../img/surgical/extractions-2.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
